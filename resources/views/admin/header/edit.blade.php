        ...
        <div class="col-xs-12 col-md-8">
            ...
            <div class="card">
              <div class="card-header personal">
                ...
                <div class="card-body">
                    <form id="cadServico" method="POST" action="{{route('admin.header.update')}}" class="needs-validation {{ $errors->any() ? ' was-validated' : '' }}" novalidate
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="logo-desc" id="logo-desc" value="{{ $header->logo-desc }}" required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="banner-desc" id="banner-desc" value="{{ $header->banner-desc }}" required autofocus>
